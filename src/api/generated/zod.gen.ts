...
export const zRecipientScope = z.enum([
  'BILL',
  'TRANSACTION'
])
...
export const zHouseholdMember = zHouseholdUser.and(
  z.object({
    user: z.optional(
      z.union([
        z.object({
...
export const zAccountWithBalance = zAccount.and(
  z.object({
...
export const zAccountDetail = zAccount.and(
  z.object({
    budgets: z.array(zBudget)
  })
)

export const zBudgetWithMetrics = zBudget.and(
  z.object({
...
export const zBudgetDetail = zBudgetWithMetrics.and(
  z.object({
...
export const zCategoryDetail = zCategory.and(
  z.object({
    budgets: z.array(zBudget)
  })
)
...
export const zCreateTransactionRequest = z.object({
  ...
  transferToAccountId: z.optional(
    z.union([
      z.string(),
      z.null()
    ])
 ...
 */
export const zGetMultiAccountBalanceHistoryResponse =
  zAccountBalanceHistoryResponse
