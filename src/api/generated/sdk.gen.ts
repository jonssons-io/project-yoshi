 ...
 *
 */
export const bulkCreateTransactions = <ThrowOnError extends boolean = false>(options: Options<BulkCreateTransactionsData, ThrowOnError>) => (options.client ?? client).post<BulkCreateTransactionsResponses, BulkCreateTransactionsErrors, ThrowOnError>({
    requestValidator: async (data) => await zBulkCreateTransactionsData.parseAsync(data),
    responseValidator: async (data) => await zBulkCreateTransactionsResponse2.parseAsync(data),
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 *
 */
export const deleteBillScheduledRevision = <ThrowOnError extends boolean = false>(options: Options<DeleteBillScheduledRevisionData, ThrowOnError>) => (options.client ?? client).delete<DeleteBillScheduledRevisionResponses, DeleteBillScheduledRevisionErrors, ThrowOnError>({
    requestValidator: async (data) => await zDeleteBillScheduledRevisionData.parseAsync(data),
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 *
 */
export const deleteIncomeScheduledRevision = <ThrowOnError extends boolean = false>(options: Options<DeleteIncomeScheduledRevisionData, ThrowOnError>) => (options.client ?? client).delete<DeleteIncomeScheduledRevisionResponses, DeleteIncomeScheduledRevisionErrors, ThrowOnError>({
    requestValidator: async (data) => await zDeleteIncomeScheduledRevisionData.parseAsync(data),
    security: [{ scheme: 'bearer', type: 'http' }],
