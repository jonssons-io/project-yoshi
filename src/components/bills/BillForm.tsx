...
export function BillForm({
  ...
  return (
    ...
    >
      ...
      >
        {(field) => (
          <field.NumberField label="Estimated Amount" placeholder="0.00" step="0.01" />
        )}
      </form.AppField>
      ...
      >
        {(field) => (
          <field.DateField label="Start Date (First Payment)" />
        )}
      </form.AppField>
          ...
          <>
            {recurrenceType === RecurrenceType.CUSTOM && (
              <form.AppField
                ...
                validators={{
                  onChange: createZodValidator(billSchema.shape.customIntervalDays),
                }}
              >
                {(field) => (
                  <field.NumberField
