...
const transferSchema = z.object({
  fromAccountId: z.string().min(1, {
    message: 'validation.sourceAccountRequired'
  }),
  toAccountId: z.string().min(1, {
    message: 'validation.destAccountRequired'
  }),
...
type TransferTransactionPayloadOptions = {
  name?: string
  budgetId?: string
}

export function buildTransferTransactionPayload(
  data: TransferFormData,
  options?: TransferTransactionPayloadOptions
) {
  return {
